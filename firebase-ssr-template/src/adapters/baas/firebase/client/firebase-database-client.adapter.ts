/**
 * Firebase Database Client Adapter
 *
 * Implements DatabasePort interface using Firebase Firestore Client SDK.
 * Runs in the browser.
 */
...
export class FirebaseDatabaseClientAdapter<T = Record<string, unknown>>
