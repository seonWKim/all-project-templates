/**
 * Firebase Authentication Client Adapter
 *
 * Implements AuthPort interface using Firebase Authentication Client SDK.
 * Runs in the browser.
 */
...
export class FirebaseAuthClientAdapter implements AuthPort {
