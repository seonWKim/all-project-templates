/**
 * Firebase Messaging Client Adapter
 *
 * Implements MessagingPort interface using Firebase Cloud Messaging Client SDK.
 * Runs in the browser.
 */
...
export class FirebaseMessagingClientAdapter implements MessagingPort {
