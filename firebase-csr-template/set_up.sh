...
main() {
    ...
    cat << "EOF"
╔═══════════════════════════════════════╗
║   Firebase Next.js Template Setup    ║
╚═══════════════════════════════════════╝
EOF
    echo -e "${NC}"
    ...
    APP_DESCRIPTION=$(prompt_with_default "App description" "A Next.js app powered by Firebase")
...
EOF
    ...
    echo -e "${GREEN}Your project has been configured successfully!${NC}\n"
